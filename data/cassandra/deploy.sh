...
docker exec -it $CONTAINER_ID cqlsh $HOST $PORT -k hotel_reservation -e "SOURCE '/home/002_create_schema.cql'"
echo "Loading data"
docker exec -it $CONTAINER_ID cqlsh $HOST $PORT -k hotel_reservation -e "SOURCE '/home/003_load_data.cql'"
