...
docker exec -it $CONTAINER_ID mysql -h$HOST -P$PORT -uvld -p'Password1!' -e"source /home/002_create_schema.sql" hotel_reservation
# echo "Loading data"
# docker exec -it $CONTAINER_ID mysql -h$HOST -P$PORT -uvld -p'Password1!' -e"source /home/003_load_data.sql" hotel_reservation
